...
from ffedit import content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, state_manager, voice_extractor, wording
from ffedit.filesystem import get_file_name, resolve_file_paths
from ffedit.processors.core import get_processors_modules
from ffedit.types import DownloadProvider
...
def render() -> None:
	...
	DOWNLOAD_PROVIDERS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		choices = ffedit.choices.download_providers,
...
def update_download_providers(download_providers : List[DownloadProvider]) -> gradio.CheckboxGroup:
	...
	download_providers = download_providers or ffedit.choices.download_providers
