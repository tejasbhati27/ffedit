...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/ffedit/ffedit-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/ffedit/{base_name}/resolve/main/{file_name}'
	}
}
