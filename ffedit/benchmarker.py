...
from ffedit import core, state_manager
from ffedit.cli_helper import render_table
from ffedit.download import conditional_download, resolve_download_url
from ffedit.filesystem import get_file_extension
from ffedit.types import BenchmarkCycleSet
from ffedit.vision import count_video_frame_total, detect_video_fps, detect_video_resolution, pack_resolution
...
def run() -> Generator[List[BenchmarkCycleSet], None, None]:
	...
	benchmarks = []
	target_paths = [ffedit.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in ffedit.choices.benchmark_set]
