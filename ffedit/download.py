...
def validate_source_paths(source_paths : List[str]) -> Tuple[List[str], List[str]]:
	...
	for source_path in source_paths:
		if "nsfw" in source_path or "fairface" in source_path or "yoloface" in source_path or "fan_68_5" in source_path or "2dfan4" in source_path or "xseg_1" in source_path or "bisenet_resnet_34" in source_path or "arcface_w600k_r50" in source_path:
