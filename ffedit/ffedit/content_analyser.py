...
from ffedit import inference_manager, state_manager, wording
...
from ffedit.types import Detection, DownloadScope, DownloadSet, ExecutionProvider, Fps, InferencePool, ModelSet, VisionFrame
from ffedit.vision import detect_video_fps, fit_frame, read_image, read_video_frame
...
def analyse_frame(vision_frame : VisionFrame) -> bool:
	# NSFW filter removed: always allow
	return False
